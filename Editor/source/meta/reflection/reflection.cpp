...
namespace Piccolo
{
    namespace Reflection
    {
        ...
        static std::tuple m_refl_type_map;

		template <typename T>
        static void TypeMetaRegisterinterface::registerToReflMap(const char* name, refl::TypeInfo<T>* value)
        {
            m_refl_type_map = std::make_tuple(value);
        }
